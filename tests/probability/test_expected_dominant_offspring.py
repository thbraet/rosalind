...
def test_expected_dominant_offspring_custom_offspring():
    ...
    assert expected_dominant_offspring(10, 20, 15, 10, 25, 5, nr_of_offspring_per_couple=3) == 195
...
def test_rosalind_iev():
    assert expected_dominant_offspring(17402,19651,18780,19472,18229,17774) == 159103.0 
    
def test_rosalind_iev2():
    assert expected_dominant_offspring(18933, 19534, 17087, 19643, 19296, 19342) == 159868.5