import pytest
import pandas as pd
from rosalind.string_algorithms import get_consensus_string, get_profile_matrix  # Replace with your module name
...
def test_rosalind_sample_problem():
    dna_list = [ "ATCCAGCT", "GGGCAACT", "ATGGATCT", "AAGCAACC", "TTGGAACT", "ATGCCATT", "ATGGCACT"]
    result = get_consensus_string(dna_list)
