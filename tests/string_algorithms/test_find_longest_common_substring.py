...
)  # Replace 'rosalind.string_algorithms' with your actual module if needed
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ["A", "A", "A"],
            ["A"],
        ),  # All single-character strings, common subsequence 'A'
